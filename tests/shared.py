...
from maras.database import Database, RecordDeleted, RecordNotFound
from maras.database import DatabaseException, RevConflict, DatabasePathException, DatabaseConflict, PreconditionsException, IndexConflict

from maras.hash_index import HashIndex, UniqueHashIndex, MultiHashIndex
from maras.index import IndexException, TryReindexException, IndexNotFoundException, IndexPreconditionsException

from maras.tree_index import TreeBasedIndex, MultiTreeBasedIndex

from maras.debug_stuff import database_step_by_step
...
class TreeMultiTest(MultiTreeBasedIndex):
    ...
    custom_header = """from maras.tree_index import MultiTreeBasedIndex
...
#        el['new_data']='new'
    ...
    def test_patch_flush_fsync(self, tmpdir):
        from maras.patch import patch_flush_fsync
        db = self._db(os.path.join(str(tmpdir), 'db'))
        db.create()
